...
const Index = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden">
      {/* Enhanced bluish background with layered design */}
      <div className="fixed inset-0 bg-gradient-to-br from-blue-100 via-blue-50/90 to-sky-100/70 -z-20"></div>
      <div className="fixed inset-0 bg-[url('data:image/svg+xml,%3Csvg width=%2260%22 height=%2260%22 viewBox=%220 0 60 60%22 xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cg fill=%22none%22 fill-rule=%22evenodd%22%3E%3Cg fill=%22%233B82F6%22 fill-opacity=%220.07%22%3E%3Cpath d=%22M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z%22%3E%3C/path%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] bg-repeat opacity-30 -z-10"></div>
      <div className="fixed inset-0 bg-[url('https://images.unsplash.com/photo-1557682250-4b3f139c6989?q=80&w=2148')] bg-cover bg-center opacity-10 mix-blend-overlay -z-20"></div>
